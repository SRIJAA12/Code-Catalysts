      ...
      <section className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col items-start justify-end p-14 bg-primary-container">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-lg text-white/85 font-normal leading-relaxed mb-12 max-w-sm">
            Join over 500,000 travelers using Traveloop to craft seamless itineraries and unforgettable memories.
          </p>
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative focus-glow rounded-xl">
                ...
                >
                  {showPass
                    ? <MdVisibilityOff className="icon-sm" />
                    : <MdVisibility className="icon-sm" />
                  }
                </button>
              </div>
            </div>
            ...
            <button
              type="submit"
              className="w-full py-3.5 px-6 bg-primary text-white text-sm font-bold rounded-xl hover:bg-primary/90 hover:-translate-y-0.5 active:scale-[0.98] transition-all shadow-md shadow-primary/20 flex items-center justify-center mt-2"
            >
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 py-3 px-5 border border-outline-variant/40 rounded-xl text-sm font-semibold text-on-surface bg-white hover:bg-surface-container-low transition-all"
            >
              {/* Google SVG mark */}
